            ...
            //            While(iter.hasNext()){
                    ...
                    %>
                        ...
                        <table style="color:black;">
                            <tr>
                                <td><input class="form-control" type="button" id="dno" value="Politics:Book<%=doc.docno()%>" class="btn btn-default"/></td>
				...
				//document.write('Abstract:'+description+"<br>")
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                <img src="img/p1.jpg" alt="book" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=0226467716">Read Me</a>
                                    </h4>
                                    <p></p>
                                </div>
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                <img src="img/p2.jpg" alt="book" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=081664845X">Read Me</a>
                                    </h4>
                                    <p></p>
                                </div>
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                 <img src="img/p3.jpg" alt="book" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=0199696004">Read Me</a>
                                    </h4>
                                    <p></p>
                                </div>
