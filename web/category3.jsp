            ...
            //            While(iter.hasNext()){
                    ...
                    %>
                        ...
                        <table style="color:black;">
                            <tr>
                                <td><input class="form-control" type="button" id="dno" value="Book For Psycholog:" class="btn btn-default"/></td>
				...
				//document.write('Abstract:'+description+"<br>")
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                 <img src="img/ps1.jpg" alt="book" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=0801838428">Read Me</a>
                                    </h4>
                                    <p></p>
                                </div>
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                 <img src="img/ps2.jpg" alt="book" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=0170122123">Read Me</a>
                                    </h4>
                                    <p></p>
                                </div>
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                               <img src="img/ps3.jpg" alt="book" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=0743236726"></a>
                                    </h4>
                                    <p></p>
                                </div>
