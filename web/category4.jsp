            ...
            //            While(iter.hasNext()){
                    ...
                    %>
                        ...
                        <table style="color:black;">
                            <tr>
                                <td><input class="form-control" type="button" id="dno" value="Biology:Book<%=doc.docno()%>" class="btn btn-default"/></td>
				...
				//document.write('Abstract:'+description+"<br>")
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                <img src="img/bio1.jpg" alt="biologybook" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=0199142602">Read Me</a>
                                    </h4>
                                    <p></p>
                                </div>
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                <img src="img/bio2.jpg" alt="biologybook" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=1454910682">Read Me</a>
                                    </h4>
                                    <p></p>
                                </div>
                        ...
                        <div class="col-sm-4 col-lg-4 col-md-4">
                            <div class="thumbnail">
                                <img src="img/bio3.jpg" alt="biologybook" style="width:338px;height:368px;">
                                <div class="caption">
                                    <h4 class="pull-right"></h4>
                                    <h4><a href="bookViewer.jsp?name=0174480199">Read Me</a>
                                    </h4>
                                    <p></p>
                                </div>
